...
function favoriteQuotes() {
    _quotes_js__WEBPACK_IMPORTED_MODULE_1__.quoteLib.filter(element => {
        if (element.favorite === true) main.appendChild((0,_pageSetup_js__WEBPACK_IMPORTED_MODULE_0__.createCards)(element.quote, element.quoter));
    })
