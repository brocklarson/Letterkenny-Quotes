...
const createCards = () => {
    ...
    favoriteQuoters.innerText = quoter.join(', ');
    ...
    copyBtn.classList.add('material-icons-outlined', 'favorite-copy');
...
const buttonFunction = (() => {
    ...
    function findMatches(search) {
        _quotes_js__WEBPACK_IMPORTED_MODULE_1__.quoteLib.filter(element => {
            if (element.quote.toLowerCase().includes(search) || element.quoter.some(s => s.toLowerCase().includes(search))) {
                createCards(element.quote, element.quoter);
            }
        })
    }
    ...
    function createCards(quote, quoter) {
        ...
        quotesContainer.appendChild(favoriteCard);
        favoriteCard.appendChild(favoriteQuote);
        favoriteCard.appendChild(favoriteQuoters);
        favoriteCard.appendChild(iconContainer);
        iconContainer.appendChild(favoriteBtn);
